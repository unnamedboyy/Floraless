...
export default function Hero() {
  ...
  return (
    <section className="bg-white py-0 px=0">
        ...
        <div className="relative px=7 h-[80vh] overflow-hidden shadow-[0_30px_80px_rgba(0,0,0,0.18)]">
            ...
            <div className="relative w-[600px] overflow-hidden">
              ...
              >
                {allCards.map((img, i) => (
                  <div
                    key={i}
                    className="relative h-[360px] w-[400px] flex-shrink-0 overflow-hidden rounded-[22px] shadow-2xl"
                  >
                    <Image
                      src={img}
                      alt="gallery"
